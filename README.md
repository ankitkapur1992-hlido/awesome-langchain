...
- [Hlido](https://github.com/ankitkapur1992-hlido/hlido-public/tree/main/integrations/hlido-trust): Independent, evidence-backed trust scores for AI agents — drop-in LangChain tools (`hlido_trust_check`, `hlido_recommend`) to vet an agent before you delegate to it. `pip install "hlido[langchain]"` ![GitHub Repo stars](https://img.shields.io/github/stars/ankitkapur1992-hlido/hlido-public?style=social)
